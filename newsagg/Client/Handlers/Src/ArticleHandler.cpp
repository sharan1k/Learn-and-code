...
void ArticleHandler::saveArticle(unsigned int userId, unsigned int articleId, SaveArticleCallback callback) {
...
void ArticleHandler::removeSavedArticle(unsigned int userId, unsigned int articleId, SaveArticleCallback callback) {
...
void ArticleHandler::likeArticle(unsigned int userId, unsigned int articleId, SaveArticleCallback callback) {
...
void ArticleHandler::dislikeArticle(unsigned int userId, unsigned int articleId, SaveArticleCallback callback) {
